...
{
    public class TTTruyenThongVIIVDA : ITTTruyenThongVIIVDA
    {
        ...
        /// <summary>
        /// Lấy kết quả Thông tin Truyền thông VIIV theo id
        /// </summary>
        /// <param name="id"></param>
        /// <returns></returns>
        public TTTruyenThongVIIVPageModel GetItemById(int id)
        {
            var result = new TTTruyenThongVIIVPageModel();

            var param = new List<SqlParameter>
                {
                    new SqlParameter("Id", id),
                };
            var resultPro = _DatabaseSql.ExecuteProcToList<TTTruyenThongVIIVPageModel>(Constants.SP_TTTruyenThongVIIV_Get_By_Id, param).ToList();
        ...
        /// <summary>
        /// Lấy kết quả Thông tin Truyền thông VIIV theo trang
        /// </summary>
        /// <param name="modelSearch"></param>
        /// <param name="pageSize"></param>
        /// <returns></returns>
        public List<TTTruyenThongVIIVPageModel> GetAllByPage(ModelSearch modelSearch)
        {
            var result = new List<TTTruyenThongVIIVPageModel>();
            try
            {
                var param = new List<SqlParameter>
                {
                ...
                result = _DatabaseSql.ExecuteProcToList<TTTruyenThongVIIVPageModel>(Constants.SP_TTTruyenThongVIIV_Get_By_Page, param).ToList();
            }
            catch (Exception ex)
            {
                var log = new BVTL_QT_LOG
                {
                    ControllerName = "TTTruyenThongVIIVDA",
                    UserName = "",
                    DateLog = DateTime.Now,
                    Content = "Lấy danh sách kết quả Thông tin Truyền thông VIIV theo trang lỗi:" + ex.Message
                };
                db.BVTL_QT_LOG.Add(log);
                result = new List<TTTruyenThongVIIVPageModel>();
            }
            return result;
        }
    }
