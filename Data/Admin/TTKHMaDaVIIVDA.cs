...
{
    public class TTKHMaDaVIIVDA : ITTKHMaDaVIIVDA
    {
        ...
        /// <summary>
        /// Lấy kết quả KH Mất dấu theo id
        /// </summary>
        /// <param name="id"></param>
        /// <returns></returns>
        public TTKHMaDaVIIVPageModel GetItemById(int id)
        {
            var result = new TTKHMaDaVIIVPageModel();

            var param = new List<SqlParameter>
                {
                    new SqlParameter("Id", id),
                };
            var resultPro = _DatabaseSql.ExecuteProcToList<TTKHMaDaVIIVPageModel>(Constants.SP_TTKHMaDaVIIV_Get_By_Id, param).ToList();
        ...
        /// <summary>
        /// Lấy kết quả KH Mất dấu theo trang
        /// </summary>
        /// <param name="modelSearch"></param>
        /// <param name="pageSize"></param>
        /// <returns></returns>
        public List<TTKHMaDaVIIVPageModel> GetAllByPage(ModelSearch modelSearch)
        {
            var result = new List<TTKHMaDaVIIVPageModel>();
            try
            {
                var param = new List<SqlParameter>
                {
                ...
                result = _DatabaseSql.ExecuteProcToList<TTKHMaDaVIIVPageModel>(Constants.SP_TTKHMaDaVIIV_Get_By_Page, param).ToList();
            }
            catch (Exception ex)
            {
                var log = new BVTL_QT_LOG
                {
                    ControllerName = "TTKHMaDaVIIVDA",
                    UserName = "",
                    DateLog = DateTime.Now,
                    Content = "Lấy danh sách kết quả Thông tin KH Mất dấu VIIV theo trang lỗi:" + ex.Message
                };
                db.BVTL_QT_LOG.Add(log);
                result = new List<TTKHMaDaVIIVPageModel>();
            }
            return result;
        }
    }
