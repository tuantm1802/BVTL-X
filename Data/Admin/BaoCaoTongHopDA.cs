...
namespace Data.Admin
{
    public class BaoCaoTongHopDA : IBaoCaoTongHopDA
    {
        ...
        public List<BaoCaoModel> GetDataReportVIIV(ReportSearchModel modelSearch)
        {
            var result = new List<BaoCaoModel>();
            try
            {
                ...
                result = _DatabaseSql.ExecuteProcToList<BaoCaoModel>(Constants.SP_Report_Get_All_Data_VIIV, param).ToList();
            }
            catch (Exception ex)
            {
                var log = new BVTL_QT_LOG
        ...
        public List<BaoCaoModel> GetDataYearReportVIIV(ReportSearchModel modelSearch)
        {
            var result = new List<BaoCaoModel>();
            try
            {
                ...
                result = _DatabaseSql.ExecuteProcToList<BaoCaoModel>(Constants.SP_Report_Get_All_Data_Year_VIIV, param).ToList();
            }
            catch (Exception ex)
            {
                var log = new BVTL_QT_LOG
        ...
        public List<BaoCaoTongHopQuyVIIVModel> LayDuLieuBaoCaoHoatDongCD43(ReportSearchModel modelSearch)
        {
            var result = new List<BaoCaoTongHopQuyVIIVModel>();
            try
            {
                ...
                var resultPro = _DatabaseSql.ExecuteProcToList<BaoCaoTongHopQuyVIIVProModel>(Constants.SP_Report_BC_Tong_Hop_Quy_CD43, param).ToList();
                if (resultPro != null && resultPro.Count > 0)
                {
                    var listQuys = new List<ListQuyModel>();
                    // Tính toán các quý
        ...
        public List<BaoCaoModel> GetDataReportCH07(ReportSearchModel modelSearch)
        {
            var result = new List<BaoCaoModel>();
            try
            {
                ...
                result = _DatabaseSql.ExecuteProcToList<BaoCaoModel>(Constants.SP_Report_Get_All_Data_CH07, param).ToList();
            }
            catch (Exception ex)
            {
                var log = new BVTL_QT_LOG
