...
{
    public class BaoCaoNamVIIVController : BaseController
    {
        ...
        public BaoCaoNamVIIVController(ICityDA cityDA, IDuAnDA duAnDA, IBaoCaoTongHopDA baoCaoTongHopDA, IBVTL_NHOM_TBHDA bVTL_NHOM_TBHDA, ISysLogDA sysLogDA)
        {
            _CityDA = cityDA;
            _DuAnDA = duAnDA;
        ...
        // GET: BaoCaoNamVIIV
        [HasCredential(ControllerName = "BaoCaoNamVIIV")]
        ...
        public ActionResult SearchData(ReportSearchModel modelSearch)
        {
            ...
            try
            {
                ...
                AddLog("Lấy dữ liệu báo cáo năm ( năm: " + modelSearch.Year + ", tỉnh: " + modelSearch.CityCodes + ") thành công.");
            ...
            catch (Exception ex)
            {
                ...
                AddLog("Lấy dữ liệu báo cáo  năm ( năm: " + modelSearch.Year + ", tỉnh: " + modelSearch.CityCodes + ") lỗi: " + ex.Message);
        ...
        [HttpGet]
        public ActionResult ExportData(int Year, string Months, string CityCodes, string Nam, string maNhomTBHs, string maDuAn)
        {
            try
            {
                ...
                //}
                //var file_name = maDuAn + "_" + string.Join("-", nhomTBHs.Select(x => x.manhom_tbh)) + "_BAO_CAO_Nam_" + Nam+"-"+Year+".xlsx";
                var file_name = "VIIV" + "_" + CityCodes + "_BAO_CAO_Nam_" +Year+".xlsx";
        ...
        private void CreateHeader(IXLWorksheet ws, string tileReport, UserLogin user, string tenNhomTBHs)
        {
            #region header
            // 
            ws.Cell("A1").Value = "VIIVHEALTH - TỔNG HỢP BÁO CÁO";
