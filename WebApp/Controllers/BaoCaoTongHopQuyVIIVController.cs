...
{
    public class BaoCaoTongHopQuyVIIVController : BaseController
    {
        ...
        public BaoCaoTongHopQuyVIIVController(
            ICityDA cityDA,
            IDuAnDA duAnDA,
        ...
        [HttpGet]
        public ActionResult ExportData(int TuThang, int TuNam, int DenThang, int DenNam, string CityCodes, string maNhomTBHs)
        {
            try
            {
                var maDuAn = "VIIV";
                ...
                using (XLWorkbook wb = new XLWorkbook())
                {
                    ...
                    var titleReport = "Kỳ báo cáo: Báo cáo từ quý " + tuQuy + " - " + TuNam + " đến quý " + denQuy + " - " + DenNam;
                    ...
                    CreateHeader(ws, titleReport, tenNhomTBHs, listQuy);
        ...
        /// </summary>
        /// <param name="ws"></param>
        private void CreateHeader(IXLWorksheet ws, string tileReport, string tenNhomTBHs, List<ListQuyModel> listQuy)
        {
            #region header
            // 
            ws.Cell("A1").Value = "VIIVHEALTH - TỔNG HỢP BÁO CÁO THEO CHỈ TIÊU";//"BÁO CÁO 6 THÁNG (THÁNG 4,5,6,7,8,9/2021)";
