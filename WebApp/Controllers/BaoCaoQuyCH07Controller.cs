...
{
    public class BaoCaoQuyCH07Controller : BaseController
    {
        ...
        public BaoCaoQuyCH07Controller(ICityDA cityDA, IDuAnDA duAnDA, IBaoCaoTongHopDA baoCaoTongHopDA, IBVTL_NHOM_TBHDA bVTL_NHOM_TBHDA, ISysLogDA sysLogDA)
        {
            _CityDA = cityDA;
            _DuAnDA = duAnDA;
        ...
        // GET: BaoCaoQuyCH07
        [HasCredential(ControllerName = "BaoCaoQuyCH07")]
        ...
        public ActionResult ExportData(int Year, string Months, string CityCodes, string quy, string maNhomTBHs, string maDuAn)
        {
            try
            {
                ...
                var file_name = "CH07" + "_" + CityCodes + "_BAO_CAO_QUY_" + quy+"-"+Year+".xlsx";
        ...
        private void CreateHeader(IXLWorksheet ws, string tileReport, UserLogin user, string tenNhomTBHs)
        {
            #region header
            // 
            ws.Cell("A1").Value = "BÁO CÁO QUÝ DỰ ÁN CH07";
