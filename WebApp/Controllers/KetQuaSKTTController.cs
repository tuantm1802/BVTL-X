...
namespace WebApp.Controllers
{
    ...
    {
        readonly IKetQuaSKTTDA _KetQuaSKTTDA;
        readonly ISysLogDA _sysLogDA;
        readonly IDuAnDA _DuAnDA;
        BaseController _helperController = new BaseController();
        readonly ICityDA _CityDA;

        public KetQuaSKTTController(IKetQuaSKTTDA ketQuaSKTTDA, ISysLogDA sysLogDA, IDuAnDA duAnDA, ICityDA cityDA)
        {
            _KetQuaSKTTDA = ketQuaSKTTDA;
            _sysLogDA = sysLogDA;
            _DuAnDA = duAnDA;
            _CityDA = cityDA;
        }
