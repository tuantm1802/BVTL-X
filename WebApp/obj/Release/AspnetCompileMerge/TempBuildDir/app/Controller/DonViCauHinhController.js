app.controller("DonViCauHinhController", function ($scope, $uibModal, $ngConfirm, showToast, hideLoading, $timeout) {
    $scope.modelAdd = {};
    $scope.KeywordCH = '';
    $scope.model = {
        PHIEN_HIEU: '',
    ...
    function GetBottomAction() {
        $.ajax({
            type: 'post',
            url: '/DonViCauHinh/GetBottomAction',
            data: {},
    ...
    function GetAllNhomDV() {
        $.ajax({
            type: 'post',
            url: '/DonViCauHinh/GetAllNhomDonVi',
            data: {},
            success: function (data) {
    ...
    $scope.SuaDV = function () {
        ...
        //    return;
        //}
        //if ($scope.model.KHU_VUC_ID == null || $scope.model.KHU_VUC_ID == "") {
        //    toastr.error("Bạn chưa chọn Khu vực!");
        //    return;
        //}
