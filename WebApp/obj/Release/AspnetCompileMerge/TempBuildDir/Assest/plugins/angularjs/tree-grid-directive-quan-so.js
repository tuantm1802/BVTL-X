    angular.module('treeGridqs', []).directive('treeGridqs', ['$timeout',
        function ($timeout) {
            return {
                restrict: 'E',
                templateUrl: '/app/directives/tree-grid-template-quan-so.html',
                ...
                link: function (scope, element, attrs) {
                    ...
                    scope.showTdCheckbox = false;
                    if (scope.showCheckbox != null) {
                        scope.showTdCheckbox = scope.showCheckbox;
                    }

                    scope.ChangeCheckbox = function (i) {
                        if (scope.eventChangeCheckbox) {
                            scope.eventChangeCheckbox({ item: i });
                        }
                    };

                    scope.ClickChooseRow = function (i) {
                        if (scope.eventChooseRow) {
                            scope.eventChooseRow({ item: i });
                        }
                    };
