        ...
        */
        ...
        obj.createNestedHeader = function (nestedInformation) {
            ...
            for (var i = 0; i < nestedInformation.length; i++) {
                ...
                //// Number of columns
                //var numberOfRows = nestedInformation[i].rowspan;

                //// Classes container
                //var row = [];
                //// Header classes for this cell
                //for (var x = 0; x < numberOfRows; x++) {
                //    if (obj.options.row[headerIndex] && obj.options.rows[headerIndex].type == 'hidden') {
                //        numberOfRows++;
                //    }
                //    column.push(headerIndex);
                //    headerIndex++;
                ...
                //vietnt update
                //td.setAttribute('data-row', column.join(','));
