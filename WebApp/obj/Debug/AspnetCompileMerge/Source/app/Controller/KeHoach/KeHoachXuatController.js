app.controller("KeHoachXuatController", function ($scope, $uibModal, $ngConfirm, showToast, hideLoading) {
    $scope.canbo = [
    ...
    $scope.LayDanhSachHopDong = () => {
        ...
        $.ajax({
            type: 'post',
            url: '/KeHoachXuat/LayHopDong',
            data: {
                soHd: $scope.chitietTheoHangHoa.hop_dong,
