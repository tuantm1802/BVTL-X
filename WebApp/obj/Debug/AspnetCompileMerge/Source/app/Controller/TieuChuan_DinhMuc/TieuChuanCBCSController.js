app.controller("TieuChuanCBCSController", function ($scope,  $ngConfirm, showToast, hideLoading) {
    $scope.modelSearch = {};
    ...
    function GetBottomAction() {
        $.ajax({
            type: 'post',
            url: '/TieuChuanCBCS/GetBottomAction',
            data: {},
    ...
    $scope.LoadPage = function () {
        $.ajax({
            type: 'post',
            url: '/TieuChuanCBCS/GetAllByPage',
    ...
    function GetTieuChuanCBCS() {
        if ($scope.NhomCBId > 0 && $scope.NhomTCId) {
            if ($scope.LucLuongName == 'Lực lượng' || $scope.LucLuongId == 0) {
                ...
                $.ajax({
                    type: 'post',
                    url: '/TieuChuanCBCS/GetTieuChuanCBCS',
                    data: {
                        nhomCBId: $scope.NhomCBId,
                        nhomTCId: $scope.NhomTCId,
                        lucluongId: $scope.LucLuongId,
    ...
    $scope.ChangeNhomTieuChuan = function () {
        ...
        $.ajax({
            type: 'post',
            url: '/TieuChuanCBCS/SearchNhomTieuChuan',
    ...
    $scope.AddNew = function () {
        ...
        if ($scope.NhomCBId > 0 && $scope.NhomTCId > 0) {
            if ($scope.LucLuongName == 'Lực lượng' || $scope.LucLuongId == 0) {
                toastr.error('Lực lượng chọn không được là lực lượng cha.');
            } else {
    ...
    $scope.ChangeLoaiTrangPhuc = function () {
        $.ajax({
            type: 'post',
            url: '/TieuChuanCBCS/SearchSanPham',
            data: {
    ...
    $scope.add = function () {
        var modalInstance = $uibModal.open({
            ...
            templateUrl: '/TieuChuanCBCS/_Add',
            controller: 'add',
            size: 'xl',
            backdrop: 'static'
        });
    ...
    $scope.edit = function (itemId) {
        var modalInstance = $uibModal.open({
            animation: $scope.animationsEnabled,
            templateUrl: '/TieuChuanCBCS/_Edit',
            controller: 'edit',
            size: 'xl',
            backdrop: 'static',
            resolve: {
