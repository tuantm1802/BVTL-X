...
;(function ( $, window, document, undefined ) {
  ...
  ComboTree.prototype.createSourceItemHTML = function (sourceItem) {
    ...
    if (isThereSubs)
        itemHtml += '<span class="comboTreeParentPlus">' + (this.options.collapse ? '<span style="color: #e2c629" class="mdi mdi-folder"></span>' : '<span style="color: #e2c629" class="mdi mdi-folder-open"></span>') + '</span>'; // itemHtml += '<span class="comboTreeParentPlus">' + (this.options.collapse ? '+' : '&minus;') + '</span>';
  ...
  ComboTree.prototype.toggleSelectionTree = function (item, direction) {
    ...
    if (direction === undefined){
      if ($(subMenu).is(':visible'))
          $(item).children('span.comboTreeParentPlus').html('<span style="color: #e2c629" class="mdi mdi-folder"></span>'); //$(item).children('span.comboTreeParentPlus').html("+");
      else
          $(item).children('span.comboTreeParentPlus').html('<span style="color: #e2c629" class="mdi mdi-folder-open"></span>'); //$(item).children('span.comboTreeParentPlus').html("&minus;");
