app.controller("BaoCaoThangCH07Controller", function ($scope, $uibModal, $ngConfirm, showToast, hideLoading) {
    $scope.modelSearch = {};
    ...
    $scope.ExportExcel = function () {
        ...
        window.location.href = '/BaoCaoThangCH07/ExportData?Months=' + $scope.modelSearch.Months + '&Year=' + $scope.modelSearch.Year
