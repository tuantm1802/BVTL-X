app.controller("BaoCao6ThangCH07Controller", function ($scope, $uibModal, $ngConfirm, showToast, hideLoading) {
    $scope.modelSearch = {};
    ...
    function GetBottomAction() {
        ...
        $.ajax({
            type: 'post',
            url: '/BaoCao6ThangCH07/GetBottomAction',
            data: {},
    ...
    $scope.ExportExcel = function () {
        ...
        window.location.href = '/BaoCao6ThangCH07/ExportData?Months=' + $scope.modelSearch.Months + '&Year=' + $scope.modelSearch.Year
