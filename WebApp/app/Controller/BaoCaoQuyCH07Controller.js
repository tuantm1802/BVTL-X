app.controller("BaoCaoQuyCH07Controller", function ($scope, $uibModal, $ngConfirm, showToast, hideLoading) {
    $scope.modelSearch = {};
    ...
    $scope.ExportExcel = function () {
        ...
        window.location.href = '/BaoCaoQuyCH07/ExportData?Months=' + $scope.modelSearch.Months + '&Year=' + $scope.modelSearch.Year
