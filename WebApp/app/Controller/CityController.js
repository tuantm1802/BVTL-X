app.controller("CityController", function ($scope, $uibModal, $ngConfirm, showToast, hideLoading) {
    $scope.modelSearch = {};
    ...
    $('#dataTableCity').on('click', 'tr', function () {
    ...
    $scope.edit = function () {
        var seletedRow = dataTableCity.rows({ selected: true });
