app.controller("ChatGayNghien3THController", function ($scope, $uibModal, $ngConfirm, showToast, hideLoading) {
    $scope.modelSearch = {};
    ...
    function GetBottomAction() {
        $.ajax({
            type: 'post',
            url: '/ChatGayNghien3TH/GetBottomAction',
            data: {},
    ...
    $('#dataTableChatGayNghien3TH').on('click', 'tr', function () {
    ...
    $scope.LoadPage = function (genTable) {
        ...
        if (genTable == 1) {
                ...
                ajax: function (data, callback, settings) {
                    ...
                    $.ajax({
                        ...
                        success: function (respone) {
                            ...
                            $scope.ListChatGayNghien3TH = respone.data;
            ...
            dataTableChatGayNghien3TH.ajax.reload();
        }
        hideLoading();
    };
    ...
    $scope.edit = function () {
        var seletedRow = dataTableChatGayNghien3TH.rows({ selected: true });
        ...
        if ($scope.ParamIdSeleted > 0 && $scope.ParamIdSeleted != undefined) {
            var modalInstance = $uibModal.open({
                ...
                templateUrl: '/ChatGayNghien3TH/_Edit',
                controller: 'edit',
                size: 'xl',
                backdrop: 'static',
                resolve: {
