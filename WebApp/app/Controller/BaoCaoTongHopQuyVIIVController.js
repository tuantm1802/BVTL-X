app.controller("BaoCaoTongHopQuyVIIVController", function ($scope, $uibModal, $ngConfirm, showToast, hideLoading) {
    $scope.modelSearch = {};
    ...
    function GetBottomAction() {
        ...
        $.ajax({
            type: 'post',
            url: '/BaoCaoTongHopQuyVIIV/GetBottomAction',
            data: {},
    ...
    $scope.LoadPage = function (genTable) {
        ...
        $.ajax({
            type: 'post',
            url: '/BaoCaoTongHopQuyVIIV/SearchData',
            cache: false,
            async: false,
    ...
    $scope.ExportExcel = function () {
        ...
        window.location.href = '/BaoCaoTongHopQuyVIIV/ExportData?TuThang=' + $scope.modelSearch.TuThang + '&TuNam=' + $scope.modelSearch.TuNam
    ...
    $scope.Changecity = function () {
        ...
        $.ajax({
            type: 'post',
            url: '/BaoCaoTongHopQuyVIIV/GetNhomTBHByCityCodes',
            cache: false,
            async: false,
            data: {
                CityCodes: CityCodes
