app.controller("KetQuaSangLocController", function ($scope, $uibModal, $ngConfirm, showToast, hideLoading) {
    ...
    var dataTableKetQuaSangLoc = null;
    ...
    $('#dataTableKetQuaSangLoc').on('click', 'tr', function () {
    ...
    $scope.LoadPage = function (genTable) {
        ...
        if (genTable == 1 || genTable == 2) {
            if (genTable == 2)
                dataTableKetQuaSangLoc.destroy();
            dataTableKetQuaSangLoc = $('#dataTableKetQuaSangLoc').DataTable({
                ...
                //            $scope.ListKetQuaSangLoc = respone.data;
            ...
            dataTableKetQuaSangLoc.ajax.reload();
        }
        hideLoading();
    };
