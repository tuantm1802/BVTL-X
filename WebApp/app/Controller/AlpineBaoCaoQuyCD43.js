document.addEventListener('alpine:init', function () {
    Alpine.data('alpineBaoCaoQuyCD43', function () {
        return {
            modelSearch: {
                totalItems: 0,
                currentPage: 1,
            ...
            GetBottomAction: function (callback) {
                ...
                $.ajax({
                    type: 'POST',
                    url: '/BaoCaoQuyCD43/GetBottomAction',
            ...
            ExportExcel: function () {
                ...
                window.location.href = '/BaoCaoQuyCD43/ExportData?' + params.toString();
            },
            ...
            Changecity: function (callback) {
                ...
                $.ajax({
                    type: 'POST',
                    url: '/BaoCaoQuyCD43/GetNhomTBHByCityCodes',
                    cache: false,
