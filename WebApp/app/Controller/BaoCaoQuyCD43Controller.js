app.controller("BaoCaoQuyVIIVController", function ($scope, $uibModal, $ngConfirm, showToast, hideLoading) {
    $scope.modelSearch = {};
    ...
    function GetBottomAction() {
        ...
        $.ajax({
            type: 'post',
            url: '/BaoCaoQuyVIIV/GetBottomAction',
            data: {},
    ...
    $scope.ExportExcel = function () {
        ...
        window.location.href = '/BaoCaoQuyVIIV/ExportData?Months=' + $scope.modelSearch.Months + '&Year=' + $scope.modelSearch.Year
    ...
    $scope.Changecity = function () {
        ...
        $.ajax({
            type: 'post',
            url: '/BaoCaoQuyVIIV/GetNhomTBHByCityCodes',
            cache: false,
            async: false,
            data: {
                CityCodes: CityCodes
