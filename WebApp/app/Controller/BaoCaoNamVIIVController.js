app.controller("BaoCaoNamVIIVController", function ($scope, $uibModal, $ngConfirm, showToast, hideLoading) {
    $scope.modelSearch = {};
    ...
    function GetBottomAction() {
        ...
        $.ajax({
            type: 'post',
            url: '/BaoCaoNamVIIV/GetBottomAction',
            data: {},
    ...
    $scope.ExportExcel = function () {
        ...
        window.location.href = '/BaoCaoNamVIIV/ExportData?Year=' + $scope.modelSearch.Year
    ...
    $scope.Changecity = function () {
        ...
        $.ajax({
            type: 'post',
            url: '/BaoCaoNamVIIV/GetNhomTBHByCityCodes',
            cache: false,
            async: false,
            data: {
                CityCodes: CityCodes
