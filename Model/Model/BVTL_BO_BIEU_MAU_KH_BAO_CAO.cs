...
namespace Model.Model
{
    ...
    public partial class BVTL_BO_BIEU_MAU_KH_BAO_CAO
    {
        public long record_id { get; set; }
        public Nullable<System.DateTime> hanhvinguyco_timestamp { get; set; }
        public string chatgaynghien { get; set; }
        public string loaikhac { get; set; }
        public string chatgaynghien_2 { get; set; }
        public string loaikhac_2 { get; set; }
        public string duongsd { get; set; }
        public string sdheroin { get; set; }
        public string tansuatda { get; set; }
        public string tansuat_heroin { get; set; }
        public Nullable<int> tuoi { get; set; }
        public string matuydautien { get; set; }
        public string tiemchich { get; set; }
        public string dungchung { get; set; }
        public string qhtd { get; set; }
        public string qhtd_2 { get; set; }
        public string sdmatuy { get; set; }
        public string qhtdtt { get; set; }
        public string bandam { get; set; }
        public string sti { get; set; }
        public string sti1 { get; set; }
        public string loaikhac_3 { get; set; }
        public string quakhu { get; set; }
        public string hientai { get; set; }
        public string hientai_2 { get; set; }
        public string quakhu2 { get; set; }
        public string hientai_4 { get; set; }
        public string hientai_3 { get; set; }
        public string quakhu_3 { get; set; }
        public string hientai_5 { get; set; }
        public string hientai_6 { get; set; }
        public string trieuchung { get; set; }
        public string trieuchung_2 { get; set; }
        public Nullable<System.DateTime> hiv_timestamp { get; set; }
        ...
        public string cau12 { get; set; }
        public string cau13 { get; set; }
        public string cau14 { get; set; }
        public string cau15 { get; set; }
        public string cau16 { get; set; }
        public string cau17 { get; set; }
        public string cau18 { get; set; }
        public string cau19 { get; set; }
        public string cau20 { get; set; }
        public string cau21 { get; set; }
        public string cau22 { get; set; }
        public string cau23 { get; set; }
        public string cau24 { get; set; }
        public string cau25 { get; set; }
        public string cau26 { get; set; }
        public string cau27 { get; set; }
        public Nullable<System.DateTime> assist_timestamp { get; set; }
        ...
        public string lucdihoc { get; set; }
        ...
        public Nullable<System.DateTime> qst_timestamp { get; set; }
