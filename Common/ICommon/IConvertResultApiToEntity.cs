...
namespace Common.ICommon
{
    public interface IConvertResultApiToEntity
    {
        ...
        void ConvertApi1344ToEntity(List<ResultApi1344Model> resultApi1344s, ref List<BVTL_KQ_SL_SKTT> sktts, ref List<BVTL_KQ_SL_ASSIST> assists);
        ...
        void ConvertApiHIVToEntity(List<ResultApiHIVModel> resultApiHIVs, ref List<BVTL_KQ_XN_HIV> hivs);
    }
}
